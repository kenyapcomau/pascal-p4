...
CONST DISPLIMIT = 20; MAXLEVEL = 10;                                            X        1
      ...
      STACKAL = 1;                                                              INSTAL  15
      STRGLGTH = 12;                                                            INSTAL  16
      SETHIGH = 59; SETLOW = 0;                                                 INSTAL  17
      ORDMAXCHAR = 63; ORDMINCHAR = 0;                                          INSTAL  18
      LCAFTERMARKSTACK = 5;                                                     INSTAL  19
      MAXINT = 140737488355327;                                                 INSTAL  20
      FILEAL = CHARAL;                                                          P       42
...
TYPE                                                        (*DESCRIBING:*)     PASCP   60
     ...
     CONSTANT = RECORD CASE CCLASS: CSTCLASS OF                                 PASCP   83
                         ...
                         PSET: (PVAL: SET OF 0..58);                            PASCP   85
...
1:  FCP := LCP                                                                  PASCP  600
  ...
  END (*ALIGNQUOT*);                                                            P      115
                                                                                P      116
  PROCEDURE ALIGN(FSP: STP; VAR FLC: INTEGER);                                  P      117
    ...
    BEGIN                                                                       P      131
      ...
      ELSE                                                                      P      133
        BEGIN                                                                   P      134
          ...
          GETBOUNDS(FSP1,LMIN2,LMAX2);                                          P      136
          ...
          BEGIN NXT := NXT1;                                                    PASCP 1050
            ...
            WHILE NXT <> NXT1 DO                                                PASCP 1071
              WITH NXT' DO                                                      PASCP 1072
                ...
                END;                                                            PASCP 1075
            NXT1 := LCP;                                                        PASCP 1076
            IF SY = SEMICOLON THEN                                              PASCP 1077
              BEGIN INSYMBOL;                                                   PASCP 1078
                IF NOT (SY IN [IDENT,CASESY]) THEN                              PASCP 1079
        ...
        IF SY = CASESY THEN                                                     PASCP 1087
          BEGIN NEW(LSP,TAGFLD);                                                PASCP 1088
            ...
            REPEAT LSP2 := NIL;                                                 PASCP 1122
              IF NOT (SY IN [SEMICOLON,ENDSY]) THEN                             P      150
              BEGIN                                                             P      151
    ...
    (*SET*)           IF SY = SETSY THEN                                        PASCP 1267
                      BEGIN INSYMBOL;                                           PASCP 1268
                        ...
                        IF LSP1 <> NIL THEN                                     PASCP 1271
                          ...
                          ELSE                                                  PASCP 1274
                            IF LSP1 = REALPTR THEN ERROR(114);                  PASCP 1275
    ...
    PROCEDURE PROCDECLARATION(FSY: SYMBOL);                                     PASCP 1431
      ...
      PROCEDURE PARAMETERLIST(FSY: SETOFSYS; VAR FPAR: CTP);                    PASCP 1436
        VAR LCP,LCP1,LCP2,LCP3: CTP; LSP: STP; LKIND: IDKIND;                   PASCP 1437
          LLC: ADDRRANGE; COUNT,LSIZE: INTEGER;                                 P      166
     ...
     BEGIN                                                                      PASCP 1864
      ...
      PROCEDURE STATEMENT(FSYS: SETOFSYS);                                      PASCP 1883
              ...
              CASE KLASS OF                                                     PASCP 1894
                ...
                FIELD:                                                          PASCP 1904
                  WITH DISPLAY[DISX] DO                                         PASCP 1905
                    ...
                    ELSE                                                        PASCP 1910
                      BEGIN                                                     PASCP 1911
                        IF LEVEL = 1 THEN GEN1T(39(*LOD*),VDSPL,NILPTR)         P      307
                ...
                WITH GATTR, LSP' DO                                             P      341
                  BEGIN                                                         P      342
                    ...
                    IF SY = RPARENT THEN                                        P      346
                      BEGIN IF LKEY = 8 THEN ERROR(116);                        P      347
                        TEST := TRUE                                            P      348
                      END                                                       P      349
                    ELSE                                                        P      350
                ...
                WITH GATTR, LSP' DO                                             P      374
                  BEGIN                                                         P      375
                    ...
                    IF SY = RPARENT THEN                                        P      379
                      BEGIN IF LLKEY = 10 THEN ERROR(116);                      P      380
                        TEST := TRUE                                            P      381
                      END                                                       P      382
                    ELSE                                                        P      383
        ...
        BEGIN                                                                   PASCP 2889
          IF SY = INTCONST THEN                                                 PASCP 2890
            BEGIN                                                               PASCP 2891
              ...
              TTOP := TOP;                                                      PASCP 2893
              REPEAT                                                            PASCP 2894
                WHILE DISPLAY[TTOP].OCCUR <> BLCK DO TTOP := TTOP - 1;          PASCP 2895
                TTOP1 := TTOP; LLP := DISPLAY[TTOP].FLABEL;                     PASCP 2896
        ...
        BEGIN GENLABEL(LADDR); PUTLABEL(LADDR);                                 PASCP 3046
          ...
          STATEMENT(FSYS); GENUJPXJP(57(*IJP*),LADDR); PUTLABEL(LCIX)           P      500
      ...
      BEGIN (*STATEMENT*)                                                       PASCP 3151
        IF SY = INTCONST THEN (*LABEL*)                                         PASCP 3152
          BEGIN LLP := DISPLAY[TOP].FLABEL;                                     PASCP 3153
  ...
  BEGIN                                                                         PASCP 3313
    ...
    IF ERRINX <> 0 THEN INSYMBOL                                                P      555
...
FOR I:=33 TO 34 DO                                                              PASCP 3430
  ...
  PROCEDURE INITTABLES;                                                         PASCP 3541
    ...
    FOR CH := CHR(ORDMINCHAR) TO CHR(ORDMAXCHAR) DO SOP[CH] := NOOP;            BOOT     4
